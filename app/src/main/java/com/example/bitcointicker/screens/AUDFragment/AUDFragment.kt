package com.example.bitcointicker.screens.AUDFragment
...
class AUDFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        sharedViewModel.bitCoinDataAUD.observe(viewLifecycleOwner, Observer {
            ...
            text_view_header.text="Price AUD"
        })
    }
